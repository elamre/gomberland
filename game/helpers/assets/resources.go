...
func init() {
	UiResources = misc.CheckErrorRetVal[*uiResources](newUIResources())
}
...
func newButtonResources(fonts *fonts) (*buttonResources, error) {
	idle, err := loadImageNineSlice(game.ImagesFolder+"button-idle.png", 12, 0)
	if err != nil {
		return nil, err
	}

	hover, err := loadImageNineSlice(game.ImagesFolder+"button-hover.png", 12, 0)
	if err != nil {
		return nil, err
	}

	pressed, err := loadImageNineSlice(game.ImagesFolder+"button-pressed.png", 12, 0)
	if err != nil {
		return nil, err
	}

	disabled, err := loadImageNineSlice(game.ImagesFolder+"button-disabled.png", 12, 0)
	if err != nil {
		return nil, err
	}
...
func newCheckboxResources() (*checkboxResources, error) {
	idle, err := loadImageNineSlice(game.ImagesFolder+"checkbox-idle.png", 20, 0)
	if err != nil {
		return nil, err
	}

	hover, err := loadImageNineSlice(game.ImagesFolder+"checkbox-hover.png", 20, 0)
	if err != nil {
		return nil, err
	}

	disabled, err := loadImageNineSlice(game.ImagesFolder+"checkbox-disabled.png", 20, 0)
	if err != nil {
		return nil, err
	}

	checked, err := loadGraphicImages(game.ImagesFolder+"checkbox-checked-idle.png", game.ImagesFolder+"checkbox-checked-disabled.png")
	if err != nil {
		return nil, err
	}

	unchecked, err := loadGraphicImages(game.ImagesFolder+"checkbox-unchecked-idle.png", game.ImagesFolder+"checkbox-unchecked-disabled.png")
	if err != nil {
		return nil, err
	}

	greyed, err := loadGraphicImages(game.ImagesFolder+"checkbox-greyed-idle.png", game.ImagesFolder+"checkbox-greyed-disabled.png")
	if err != nil {
		return nil, err
	}
...
func newComboButtonResources(fonts *fonts) (*comboButtonResources, error) {
	idle, err := loadImageNineSlice(game.ImagesFolder+"combo-button-idle.png", 12, 0)
	if err != nil {
		return nil, err
	}

	hover, err := loadImageNineSlice(game.ImagesFolder+"combo-button-hover.png", 12, 0)
	if err != nil {
		return nil, err
	}

	pressed, err := loadImageNineSlice(game.ImagesFolder+"combo-button-pressed.png", 12, 0)
	if err != nil {
		return nil, err
	}

	disabled, err := loadImageNineSlice(game.ImagesFolder+"combo-button-disabled.png", 12, 0)
	if err != nil {
		return nil, err
	}
	...
	arrowDown, err := loadGraphicImages(game.ImagesFolder+"arrow-down-idle.png", game.ImagesFolder+"arrow-down-disabled.png")
	if err != nil {
		return nil, err
	}
...
func newListResources(fonts *fonts) (*listResources, error) {
	idle, _, err := ebitenutil.NewImageFromFile(game.ImagesFolder + "list-idle.png")
	if err != nil {
		return nil, err
	}

	disabled, _, err := ebitenutil.NewImageFromFile(game.ImagesFolder + "list-disabled.png")
	if err != nil {
		return nil, err
	}

	mask, _, err := ebitenutil.NewImageFromFile(game.ImagesFolder + "list-mask.png")
	if err != nil {
		return nil, err
	}

	trackIdle, _, err := ebitenutil.NewImageFromFile(game.ImagesFolder + "list-track-idle.png")
	if err != nil {
		return nil, err
	}

	trackDisabled, _, err := ebitenutil.NewImageFromFile(game.ImagesFolder + "list-track-disabled.png")
	if err != nil {
		return nil, err
	}

	handleIdle, _, err := ebitenutil.NewImageFromFile(game.ImagesFolder + "slider-handle-idle.png")
	if err != nil {
		return nil, err
	}

	handleHover, _, err := ebitenutil.NewImageFromFile(game.ImagesFolder + "slider-handle-hover.png")
	if err != nil {
		return nil, err
	}
...
func newSliderResources() (*sliderResources, error) {
	idle, _, err := ebitenutil.NewImageFromFile(game.ImagesFolder + "slider-track-idle.png")
	if err != nil {
		return nil, err
	}

	disabled, _, err := ebitenutil.NewImageFromFile(game.ImagesFolder + "slider-track-disabled.png")
	if err != nil {
		return nil, err
	}
	...
	handleDisabled, _, err := ebitenutil.NewImageFromFile(game.ImagesFolder + "slider-handle-disabled.png")
	if err != nil {
		return nil, err
	}
...
func newPanelResources() (*panelResources, error) {
	i, err := loadImageNineSlice(game.ImagesFolder+"panel-idle.png", 10, 10)
	if err != nil {
		return nil, err
	}
...
func newTabBookResources(fonts *fonts) (*tabBookResources, error) {
	selectedIdle, err := loadImageNineSlice(game.ImagesFolder+"button-selected-idle.png", 12, 0)
	if err != nil {
		return nil, err
	}

	selectedHover, err := loadImageNineSlice(game.ImagesFolder+"button-selected-hover.png", 12, 0)
	if err != nil {
		return nil, err
	}

	selectedPressed, err := loadImageNineSlice(game.ImagesFolder+"button-selected-pressed.png", 12, 0)
	if err != nil {
		return nil, err
	}

	selectedDisabled, err := loadImageNineSlice(game.ImagesFolder+"button-selected-disabled.png", 12, 0)
	if err != nil {
		return nil, err
	}
...
func newHeaderResources(fonts *fonts) (*headerResources, error) {
	bg, err := loadImageNineSlice(game.ImagesFolder+"header.png", 446, 9)
	if err != nil {
		return nil, err
	}
...
func newTextInputResources(fonts *fonts) (*textInputResources, error) {
	idle, _, err := ebitenutil.NewImageFromFile(game.ImagesFolder + "text-input-idle.png")
	if err != nil {
		return nil, err
	}

	disabled, _, err := ebitenutil.NewImageFromFile(game.ImagesFolder + "text-input-disabled.png")
	if err != nil {
		return nil, err
	}
...
func newToolTipResources(fonts *fonts) (*toolTipResources, error) {
	bg, _, err := ebitenutil.NewImageFromFile(game.ImagesFolder + "tool-tip.png")
	if err != nil {
		return nil, err
	}
